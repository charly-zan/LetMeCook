...
<header>
    <!--Navbar-->
    <nav class="navbar navbar-light navbar-expand-md bg-light justify-content-md-center justify-content-start fixed-top">
          ...
          <div class="text-center align-self-center  m-4 p-4">
              <div class="row">
                  <div class="col-12">
                      ...
                      <form>
                            <input class="form-control form-control-lg  " type="text" id="ingredientes" placeholder="Ingresa tus ingredientes separados por comas">
                            <button class="btn btn-dark btn- md font-weight-bold m-2 " type="button" id="buscar">Buscar recetas</button>
                        </form>
